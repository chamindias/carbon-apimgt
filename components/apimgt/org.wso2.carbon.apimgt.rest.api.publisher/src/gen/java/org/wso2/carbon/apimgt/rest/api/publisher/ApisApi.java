...
public class ApisApi  {
   ...
   private final ApisApiService delegate = ApisApiServiceFactory.getApisApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Change API monetization status", notes = "This operation is used to change API monetization status.\n", response = void.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response apisApiIdMonetizePost(@ApiParam(value = "**API ID** consisting of the **UUID** of the API. Using the **UUID** in the API call is recommended.\nThe combination of the provider of the API, name of the API and the version is also accepted as a valid API ID.\nShould be formatted as **provider-name-version**.\n",required=true ) @PathParam("apiId") @Encoded String apiId,
    @ApiParam(value = "The data elements related to change API monetization status.\n" ,required=true ) APIMonetizationInfoDTO properties)
    {
    return delegate.apisApiIdMonetizePost(apiId,properties);
    }
    @GET
