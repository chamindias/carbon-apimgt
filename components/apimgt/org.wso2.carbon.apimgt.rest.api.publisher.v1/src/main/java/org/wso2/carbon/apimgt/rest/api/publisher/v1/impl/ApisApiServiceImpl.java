...
//            }
    ...
    public Response apisApiIdMonetizePost(String apiId, APIMonetizationInfoDTO apiMonetizationInfoDTO) {
        ...
        try {
            ...
            boolean monetizationEnabled = apiMonetizationInfoDTO.getEnabled();
            ...
            //HashMap<String, String> yourHashMap = new Gson().fromJson(api.getMonetizationProperties().toString(), HashMap.class);
