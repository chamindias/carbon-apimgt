...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_API_ID_BY_IDENTIFIER = "SELECT API_ID FROM AM_API WHERE API_NAME = ? " +
            "AND API_VERSION = ? AND API_PROVIDER = ?";

    public static final String GET_PLANS_BY_API_STRIPE_PRODUCT = "SELECT TIER_NAME, STRIPE_PLAN_ID FROM AM_MONETIZATION " +
