...
CREATE TABLE AM_MONETIZATION (
            API_ID INTEGER NULL DEFAULT NULL,
            TIER_NAME VARCHAR(256) NULL DEFAULT NULL,
            PRODUCT_ID VARCHAR(256) NULL DEFAULT NULL,
            PLAN_ID VARCHAR(256) NULL DEFAULT NULL,
            FOREIGN KEY (API_ID) REFERENCES AM_API(API_ID) ON DELETE CASCADE
)/

CREATE TABLE AM_POLICY_MONETIZATION_PLAN_MAPPING (
            POLICY_UUID VARCHAR(256) NULL DEFAULT NULL,
            PRODUCT_ID VARCHAR(256) NULL DEFAULT NULL,
            PLAN_ID VARCHAR(256) NULL DEFAULT NULL,
            FOREIGN KEY (POLICY_UUID) REFERENCES AM_POLICY_SUBSCRIPTION(UUID) ON DELETE CASCADE
)/
